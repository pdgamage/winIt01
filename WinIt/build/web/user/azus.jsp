...
<%
    ...
    try {
        ...
        if (rs.next()) {
            ...
            auctionEndTime = createdAt.getTime() + (4 * 60 * 60 * 1000);
        }
        rs.close();
        ps.close();
        conn.close();
                ...
                <div class="flex space-x-14 items-center">
                    ...
                    <div id="dropdownMenu" class="hidden absolute right-0 mt-2 w-40 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                        <ul class="py-1">
                            ...
                            <li>
                                <a href="user/checkout.jsp" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">
                                    Cart
                                </a>
                            </li>
                ...
                <div class="container">
                    <div class="card">
                        <div class="left-section">
                            <img src="<%= item.getImageBase64()%>" alt="Item Image">
                        </div>
