    ...
    <body>
        ...
        <%
            ...
            if (itemlist != null && !itemlist.isEmpty()) {
                boolean hasArt = false; // To check if any antique items are found
                out.println("<div class='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-center gap-6'>");
                for (Item i : itemlist) {
                    if ("Art".equalsIgnoreCase(i.getCategory())) { // Check for category "Art"
                        hasArt = true;
        %>
        ...
        <%
                ...
                out.println("</div>");
                if (!hasArt) { // If no antiques are found, show a message
